...
HD_PWD='D:/chengxuyuan/PUF_GO/Xilinx Project/PUF_ARTY_S7_revised/PUF_ARTY_S7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iXOR_APUF_64_DOLUT_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iXOR_APUF_64_DOLUT_wrapper.tcl -notrace
