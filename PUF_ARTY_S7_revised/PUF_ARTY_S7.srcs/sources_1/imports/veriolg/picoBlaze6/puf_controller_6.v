...
module puf_controller #(parameter CLOCK_FRE = 100000000, BAUD_RATE = 9600)(
	...
	output reg [7:0] CHAl_17_PORT;
	output reg [7:0] CHAl_18_PORT;
	output reg [7:0] CHAl_19_PORT;
	output reg [7:0] CHAl_20_PORT;
	output reg [7:0] CHAl_21_PORT;
	output reg [7:0] CHAl_22_PORT;
	output reg [7:0] CHAl_23_PORT;
	output reg [7:0] CHAl_24_PORT;
...
//	--------------------
   // Decode Logic
	reg [26:0] port_en;  // Port Enable
	always@(port_id[4],port_id[3],port_id[2],port_id[1],port_id[0]) begin
	
		case({port_id[4],port_id[3],port_id[2],port_id[1],port_id[0]})
				
			5'b00000 : port_en = 27'b000000000000000000000000001 ;  // Chal_1
			5'b00001 : port_en = 27'b000000000000000000000000010 ;  // Chal_2
			5'b00010 : port_en = 27'b000000000000000000000000100 ;  // Chal_3
			5'b00011 : port_en = 27'b000000000000000000000001000 ;  // Chal_4
			5'b00100 : port_en = 27'b000000000000000000000010000 ;  // Chal_5
			5'b00101 : port_en = 27'b000000000000000000000100000 ;  // Chal_6
			5'b00110 : port_en = 27'b000000000000000000001000000 ;  // Chal_7
			5'b00111 : port_en = 27'b000000000000000000010000000 ;  // Chal_8
			5'b01000 : port_en = 27'b000000000000000000100000000 ;  // Chal_9
			5'b01001 : port_en = 27'b000000000000000001000000000 ;  // Chal_17
			5'b01010 : port_en = 27'b000000000000000010000000000 ;  // Chal_18
			5'b01011 : port_en = 27'b000000000000000100000000000 ;  // Chal_19
			5'b01100 : port_en = 27'b000000000000001000000000000 ;  // Chal_20
			5'b01101 : port_en = 27'b000000000000010000000000000 ;  // Chal_21
			5'b01110 : port_en = 27'b000000000000100000000000000 ;  // Chal_22
			5'b01111 : port_en = 27'b000000000001000000000000000 ;  // Chal_23
			5'b10000 : port_en = 27'b000000000010000000000000000 ;  // Chal_24
			5'b10001 : port_en = 27'b000000000100000000000000000 ;  // Chal_10
			5'b10010 : port_en = 27'b000000001000000000000000000 ;  // Chal_11
			5'b10011 : port_en = 27'b000000010000000000000000000 ;  // Chal_12
			5'b10100 : port_en = 27'b000000100000000000000000000 ;  // Chal_13
			5'b10101 : port_en = 27'b000001000000000000000000000 ;  // Chal_14
			5'b10110 : port_en = 27'b000010000000000000000000000 ;  // Chal_15
			5'b10111 : port_en = 27'b000100000000000000000000000 ;  // Chal_16
			5'b11000 : port_en = 27'b001000000000000000000000000 ;  // Chal_en
			5'b11001 : port_en = 27'b010000000000000000000000000 ;  // Uart_tx_write
			5'b11010 : port_en = 27'b100000000000000000000000000 ;  // PUF_Start
			default  : port_en = 27'b000000000000000000000000000 ;
	...
	always @(posedge clk) begin
		...
		if(write_strobe == 1'b 1 & port_en[17])
	...
	always @(posedge clk) begin
		...
		if(write_strobe == 1'b 1 & port_en[19])
	...
	always @(posedge clk) begin
		...
		if(write_strobe == 1'b 1 & port_en[20])
	...
	always @(posedge clk) begin
		...
		if(write_strobe == 1'b 1 & port_en[21])
	...
	always @(posedge clk) begin
		...
		if(write_strobe == 1'b 1 & port_en[22])
	...
	always @(posedge clk) begin
		...
		if(write_strobe == 1'b 1 & port_en[23])
	...
	always @(posedge clk) begin
		...
		if(write_strobe == 1'b 1 & port_en[24])
	...
	// This is a combinatorial decode because the FIFO is the 'port register'.
		...
		assign write_to_uart = write_strobe & port_en[25];
   
	// PUF_START
	always @(posedge clk) begin
    
		if(write_strobe == 1'b 1 & port_en[26])
    ...
    //chal17 
		if(write_strobe == 1'b 1 & port_en[9])
			CHAl_17_PORT <= out_port;
		else
			CHAl_17_PORT <= CHAl_17_PORT;
	end
	...
	always @(posedge clk) begin
		...
		if(write_strobe == 1'b 1 & port_en[10])
			CHAl_18_PORT <= out_port;
		else
			CHAl_18_PORT <= CHAl_18_PORT;
	end
	...
	always @(posedge clk) begin
		...
		if(write_strobe == 1'b 1 & port_en[11])
			CHAl_19_PORT <= out_port;
		else
			CHAl_19_PORT <= CHAl_19_PORT;
	end
	...
	always @(posedge clk) begin
		...
		if(write_strobe == 1'b 1 & port_en[12])
			CHAl_20_PORT <= out_port;
		else
			CHAl_20_PORT <= CHAl_20_PORT;
	end
	...
	always @(posedge clk) begin
		...
		if(write_strobe == 1'b 1 & port_en[13])
			CHAl_21_PORT <= out_port;
		else
			CHAl_21_PORT <= CHAl_21_PORT;
	end
	
	always @(posedge clk) begin
    
		if(write_strobe == 1'b 1 & port_en[14])
			CHAl_22_PORT <= out_port;
		else
			CHAl_22_PORT <= CHAl_22_PORT;
	end
	
	always @(posedge clk) begin
    
		if(write_strobe == 1'b 1 & port_en[15])
			CHAl_23_PORT <= out_port;
		else
			CHAl_23_PORT <= CHAl_23_PORT;
	end
	
	always @(posedge clk) begin
    
		if(write_strobe == 1'b 1 & port_en[16])
			CHAl_24_PORT <= out_port;
		else
			CHAl_24_PORT <= CHAl_24_PORT;
	end
